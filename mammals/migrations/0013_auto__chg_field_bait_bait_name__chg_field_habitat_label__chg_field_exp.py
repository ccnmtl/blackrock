...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Bait.bait_name'
        db.alter_column('mammals_bait', 'bait_name', self.gf('django.db.models.fields.CharField')(max_length=256))

        # Changing field 'Habitat.label'
        db.alter_column('mammals_habitat', 'label', self.gf('django.db.models.fields.CharField')(max_length=256))

        # Changing field 'Expedition.school_contact_1_email'
        db.alter_column('mammals_expedition', 'school_contact_1_email', self.gf('django.db.models.fields.CharField')(max_length=256))

        # Changing field 'Expedition.school_contact_2_email'
        db.alter_column('mammals_expedition', 'school_contact_2_email', self.gf('django.db.models.fields.CharField')(max_length=256))

        # Changing field 'Expedition.school_contact_1_phone'
        db.alter_column('mammals_expedition', 'school_contact_1_phone', self.gf('django.db.models.fields.CharField')(max_length=256))

        # Changing field 'Expedition.school_contact_2_phone'
        db.alter_column('mammals_expedition', 'school_contact_2_phone', self.gf('django.db.models.fields.CharField')(max_length=256))

        # Adding field 'Trap.notes'
        db.add_column('mammals_trap', 'notes', self.gf('django.db.models.fields.CharField')(default='', max_length=256, blank=True), keep_default=False)

        # Changing field 'Trap.trap_string'
        db.alter_column('mammals_trap', 'trap_string', self.gf('django.db.models.fields.CharField')(max_length=256))

        # Changing field 'Animal.tag_info'
        db.alter_column('mammals_animal', 'tag_info', self.gf('django.db.models.fields.CharField')(max_length=256))

        # Changing field 'GradeLevel.label'
        db.alter_column('mammals_gradelevel', 'label', self.gf('django.db.models.fields.CharField')(max_length=256))

        # Changing field 'Species.common_name'
        db.alter_column('mammals_species', 'common_name', self.gf('django.db.models.fields.CharField')(max_length=512))

        # Changing field 'Species.latin_name'
        db.alter_column('mammals_species', 'latin_name', self.gf('django.db.models.fields.CharField')(max_length=256))


    def backwards(self, orm):
        
        # Changing field 'Bait.bait_name'
        db.alter_column('mammals_bait', 'bait_name', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Habitat.label'
        db.alter_column('mammals_habitat', 'label', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Expedition.school_contact_1_email'
        db.alter_column('mammals_expedition', 'school_contact_1_email', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Expedition.school_contact_2_email'
        db.alter_column('mammals_expedition', 'school_contact_2_email', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Expedition.school_contact_1_phone'
        db.alter_column('mammals_expedition', 'school_contact_1_phone', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Expedition.school_contact_2_phone'
        db.alter_column('mammals_expedition', 'school_contact_2_phone', self.gf('django.db.models.fields.TextField')())

        # Deleting field 'Trap.notes'
        db.delete_column('mammals_trap', 'notes')

        # Changing field 'Trap.trap_string'
        db.alter_column('mammals_trap', 'trap_string', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Animal.tag_info'
        db.alter_column('mammals_animal', 'tag_info', self.gf('django.db.models.fields.TextField')())

        # Changing field 'GradeLevel.label'
        db.alter_column('mammals_gradelevel', 'label', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Species.common_name'
        db.alter_column('mammals_species', 'common_name', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Species.latin_name'
        db.alter_column('mammals_species', 'latin_name', self.gf('django.db.models.fields.TextField')())
