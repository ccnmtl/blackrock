...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'GridSquare.label_2'
        db.delete_column('mammals_gridsquare', 'label_2')

        # Deleting field 'GridSquare.label'
        db.delete_column('mammals_gridsquare', 'label')

        # Adding field 'GridSquare.terrain_difficulty'
        db.add_column('mammals_gridsquare', 'terrain_difficulty', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Changing field 'TrapLocation.understory'
        db.alter_column('mammals_traplocation', 'understory', self.gf('django.db.models.fields.TextField')(null=True))


    def backwards(self, orm):
        
        # Adding field 'GridSquare.label_2'
        db.add_column('mammals_gridsquare', 'label_2', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'GridSquare.label'
        db.add_column('mammals_gridsquare', 'label', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Deleting field 'GridSquare.terrain_difficulty'
        db.delete_column('mammals_gridsquare', 'terrain_difficulty')

        # Changing field 'TrapLocation.understory'
        db.alter_column('mammals_traplocation', 'understory', self.gf('django.db.models.fields.TextField')(default=''))
    ...
    models = {
        ...
        'mammals.expedition': {
            'Meta': {'ordering': "['-end_date_of_expedition']", 'object_name': 'Expedition'},
            ...
            'overnight_temperature_int': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'school': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['mammals.School']", 'null': 'True', 'blank': 'True'}),
        ...
        'mammals.gridsquare': {
            ...
            'access_difficulty': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            ...
            'terrain_difficulty': ('django.db.models.fields.IntegerField', [], {'default': '0'})
        },
        'mammals.habitat': {
            'Meta': {'ordering': "['label']", 'object_name': 'Habitat'},
            'blurb': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'color_for_map': ('django.db.models.fields.CharField', [], {'max_length': '3', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'mammals.traplocation': {
            ...
            'understory': ('django.db.models.fields.TextField', [], {'default': "''", 'null': 'True', 'blank': 'True'}),
