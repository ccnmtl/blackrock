...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TrapLocation.transect_distance'
        db.add_column('mammals_traplocation', 'transect_distance', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TrapLocation.transect_distance'
        db.delete_column('mammals_traplocation', 'transect_distance')
