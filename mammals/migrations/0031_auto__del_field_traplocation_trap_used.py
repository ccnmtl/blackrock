...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'TrapLocation.trap_used'
        db.delete_column('mammals_traplocation', 'trap_used_id')


    def backwards(self, orm):
        
        # Adding field 'TrapLocation.trap_used'
        db.add_column('mammals_traplocation', 'trap_used', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mammals.Trap'], null=True, blank=True), keep_default=False)
