...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('mammals_expedition', 'school_name', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True), keep_default=False)
    ...
    models = {
        ...
        'mammals.expedition': {
            ...
            'school_name': ('django.db.models.fields.CharField', [], {'max_length': '256', 'null': 'True', 'blank': 'True'}),
