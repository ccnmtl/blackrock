...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Expedition.real'
        db.add_column('mammals_expedition', 'real', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Expedition.real'
        db.delete_column('mammals_expedition', 'real')
