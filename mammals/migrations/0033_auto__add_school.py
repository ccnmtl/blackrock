...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'School'
        db.create_table('mammals_school', (
            ...
            ('contact_1_name', self.gf('django.db.models.fields.CharField')(max_length=256, blank=True)),
            ('contact_1_phone', self.gf('django.db.models.fields.CharField')(max_length=256, blank=True)),
            ('contact_1_email', self.gf('django.db.models.fields.CharField')(max_length=256, blank=True)),
            ('contact_2_name', self.gf('django.db.models.fields.CharField')(max_length=256, blank=True)),
            ('contact_2_phone', self.gf('django.db.models.fields.CharField')(max_length=256, blank=True)),
            ('contact_2_email', self.gf('django.db.models.fields.CharField')(max_length=256, blank=True)),
            ('notes', self.gf('django.db.models.fields.CharField')(max_length=256, blank=True)),
        ))
        db.send_create_signal('mammals', ['School'])


    def backwards(self, orm):
        
        # Deleting model 'School'
        db.delete_table('mammals_school')
