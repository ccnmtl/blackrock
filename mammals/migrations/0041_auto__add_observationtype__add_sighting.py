...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('mammals_observationtype', (
        ...
        db.send_create_signal('mammals', ['ObservationType'])

        # Adding model 'Sighting'
        db.create_table('mammals_sighting', (
            ...
            ('observation_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mammals.ObservationType'], null=True, blank=True)),
            ('observers', self.gf('django.db.models.fields.TextField')(default=None, null=True, blank=True)),
            ('how_many_observed', self.gf('django.db.models.fields.IntegerField')(default=None, null=True, blank=True)),
            ('notes', self.gf('django.db.models.fields.TextField')(default=None, null=True, blank=True)),
        ))
        db.send_create_signal('mammals', ['Sighting'])


    def backwards(self, orm):
        
        # Deleting model 'ObservationType'
        db.delete_table('mammals_observationtype')

        # Deleting model 'Sighting'
        db.delete_table('mammals_sighting')
    ...
    models = {
        ...
        'mammals.observationtype': {
            'Meta': {'object_name': 'ObservationType', '_ormbases': ['mammals.LabelMenu']},
            'labelmenu_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['mammals.LabelMenu']", 'unique': 'True', 'primary_key': 'True'})
        },
        'mammals.school': {
        ...
        'mammals.sighting': {
            ...
            'how_many_observed': ('django.db.models.fields.IntegerField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'location': ('django.contrib.gis.db.models.fields.PointField', [], {'null': 'True', 'blank': 'True'}),
            'notes': ('django.db.models.fields.TextField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            'observation_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['mammals.ObservationType']", 'null': 'True', 'blank': 'True'}),
            'observers': ('django.db.models.fields.TextField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            'species': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['mammals.Species']", 'null': 'True', 'blank': 'True'})
        },
        'mammals.species': {
