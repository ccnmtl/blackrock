...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Expedition.school_contact_2_name'
        db.delete_column('mammals_expedition', 'school_contact_2_name')

        # Deleting field 'Expedition.school_contact_1_email'
        db.delete_column('mammals_expedition', 'school_contact_1_email')

        # Deleting field 'Expedition.school_contact_2_phone'
        db.delete_column('mammals_expedition', 'school_contact_2_phone')

        # Deleting field 'Expedition.school_name'
        db.delete_column('mammals_expedition', 'school_name')

        # Deleting field 'Expedition.school_contact_1_phone'
        db.delete_column('mammals_expedition', 'school_contact_1_phone')

        # Deleting field 'Expedition.school_contact_1_name'
        db.delete_column('mammals_expedition', 'school_contact_1_name')

        # Deleting field 'Expedition.school_contact_2_email'
        db.delete_column('mammals_expedition', 'school_contact_2_email')

        # Adding field 'Expedition.school'
        db.add_column('mammals_expedition', 'school', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Expedition.school_contact_2_name'
        db.add_column('mammals_expedition', 'school_contact_2_name', self.gf('django.db.models.fields.CharField')(default='', max_length=256, blank=True), keep_default=False)

        # Adding field 'Expedition.school_contact_1_email'
        db.add_column('mammals_expedition', 'school_contact_1_email', self.gf('django.db.models.fields.CharField')(default='', max_length=256, blank=True), keep_default=False)

        # Adding field 'Expedition.school_contact_2_phone'
        db.add_column('mammals_expedition', 'school_contact_2_phone', self.gf('django.db.models.fields.CharField')(default='', max_length=256, blank=True), keep_default=False)

        # Adding field 'Expedition.school_name'
        db.add_column('mammals_expedition', 'school_name', self.gf('django.db.models.fields.CharField')(default='', max_length=256, blank=True), keep_default=False)

        # Adding field 'Expedition.school_contact_1_phone'
        db.add_column('mammals_expedition', 'school_contact_1_phone', self.gf('django.db.models.fields.CharField')(default='', max_length=256, blank=True), keep_default=False)

        # Adding field 'Expedition.school_contact_1_name'
        db.add_column('mammals_expedition', 'school_contact_1_name', self.gf('django.db.models.fields.CharField')(default='', max_length=256, blank=True), keep_default=False)

        # Adding field 'Expedition.school_contact_2_email'
        db.add_column('mammals_expedition', 'school_contact_2_email', self.gf('django.db.models.fields.CharField')(default='', max_length=256, blank=True), keep_default=False)

        # Deleting field 'Expedition.school'
        db.delete_column('mammals_expedition', 'school_id')
    ...
    models = {
        ...
        'mammals.expedition': {
            ...
            'school': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'}),
        ...
        'mammals.habitat': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image_path_for_legend': ('django.db.models.fields.CharField', [], {'max_length': '256', 'blank': 'True'}),
            'label': ('django.db.models.fields.CharField', [], {'max_length': '256', 'blank': 'True'})
        },
        ...
        'mammals.school': {
            ...
            'contact_1_email': ('django.db.models.fields.CharField', [], {'max_length': '256', 'blank': 'True'}),
            'contact_1_name': ('django.db.models.fields.CharField', [], {'max_length': '256', 'blank': 'True'}),
            'contact_1_phone': ('django.db.models.fields.CharField', [], {'max_length': '256', 'blank': 'True'}),
            'contact_2_email': ('django.db.models.fields.CharField', [], {'max_length': '256', 'blank': 'True'}),
            'contact_2_name': ('django.db.models.fields.CharField', [], {'max_length': '256', 'blank': 'True'}),
            'contact_2_phone': ('django.db.models.fields.CharField', [], {'max_length': '256', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
