...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TrapLocation.understory'
        db.add_column('mammals_traplocation', 'understory', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True), keep_default=False)

        # Adding field 'TrapLocation.cloud_cover'
        db.add_column('mammals_traplocation', 'cloud_cover', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='trap_cloudcover', null=True, to=orm['mammals.ExpeditionCloudCover']), keep_default=False)

        # Adding field 'TrapLocation.ovenight_temperature'
        db.add_column('mammals_traplocation', 'ovenight_temperature', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='trap_temperature', null=True, to=orm['mammals.ExpeditionOvernightTemperature']), keep_default=False)

        # Adding field 'TrapLocation.ovenight_precipitation'
        db.add_column('mammals_traplocation', 'ovenight_precipitation', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='trap_precipitation', null=True, to=orm['mammals.ExpeditionOvernightPrecipitation']), keep_default=False)

        # Adding field 'TrapLocation.ovenight_precipitation_type'
        db.add_column('mammals_traplocation', 'ovenight_precipitation_type', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='trap_precipitation_type', null=True, to=orm['mammals.ExpeditionOvernightPrecipitationType']), keep_default=False)

        # Adding field 'TrapLocation.moon_phase'
        db.add_column('mammals_traplocation', 'moon_phase', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='trap_moon_phase', null=True, to=orm['mammals.ExpeditionMoonPhase']), keep_default=False)

        # Adding field 'TrapLocation.illumination'
        db.add_column('mammals_traplocation', 'illumination', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='trap_illumination', null=True, to=orm['mammals.Illumination']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TrapLocation.understory'
        db.delete_column('mammals_traplocation', 'understory')

        # Deleting field 'TrapLocation.cloud_cover'
        db.delete_column('mammals_traplocation', 'cloud_cover_id')
        ...
        # Deleting field 'TrapLocation.moon_phase'
        db.delete_column('mammals_traplocation', 'moon_phase_id')

        # Deleting field 'TrapLocation.illumination'
        db.delete_column('mammals_traplocation', 'illumination_id')
    ...
    models = {
        ...
        'mammals.traplocation': {
            ...
            'ovenight_precipitation': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'trap_precipitation'", 'null': 'True', 'to': "orm['mammals.ExpeditionOvernightPrecipitation']"}),
            'ovenight_precipitation_type': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'trap_precipitation_type'", 'null': 'True', 'to': "orm['mammals.ExpeditionOvernightPrecipitationType']"}),
            'ovenight_temperature': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'trap_temperature'", 'null': 'True', 'to': "orm['mammals.ExpeditionOvernightTemperature']"}),
