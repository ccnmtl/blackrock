...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Habitat.color_for_map'
        db.add_column('mammals_habitat', 'color_for_map', self.gf('django.db.models.fields.CharField')(default='', max_length=3, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Habitat.color_for_map'
        db.delete_column('mammals_habitat', 'color_for_map')
