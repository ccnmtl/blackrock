...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('mammals_gridsquare', 'center', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='square_i_am_in', to=orm['mammals.GridPoint']), keep_default=False)
