...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TrapLocation.team_letter'
        db.alter_column('mammals_traplocation', 'team_letter', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))

        # Changing field 'TrapLocation.team_number'
        db.alter_column('mammals_traplocation', 'team_number', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'TrapLocation.order'
        db.alter_column('mammals_traplocation', 'order', self.gf('django.db.models.fields.IntegerField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'TrapLocation.team_letter'
        db.alter_column('mammals_traplocation', 'team_letter', self.gf('django.db.models.fields.CharField')(default='', max_length=256))

        # Changing field 'TrapLocation.team_number'
        db.alter_column('mammals_traplocation', 'team_number', self.gf('django.db.models.fields.IntegerField')(default=1))

        # Changing field 'TrapLocation.order'
        db.alter_column('mammals_traplocation', 'order', self.gf('django.db.models.fields.IntegerField')(default=1))
