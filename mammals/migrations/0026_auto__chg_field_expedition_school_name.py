...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Expedition.school_name'
        db.alter_column('mammals_expedition', 'school_name', self.gf('django.db.models.fields.CharField')(max_length=256))


    def backwards(self, orm):
        
        # Changing field 'Expedition.school_name'
        db.alter_column('mammals_expedition', 'school_name', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))
