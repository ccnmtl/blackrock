...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Expedition.overnight_temperature'
        db.add_column('mammals_expedition', 'overnight_temperature', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='exp_temperature', null=True, to=orm['mammals.ExpeditionOvernightTemperature']), keep_default=False)

        # Adding field 'Expedition.overnight_precipitation'
        db.add_column('mammals_expedition', 'overnight_precipitation', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='exp_precipitation', null=True, to=orm['mammals.ExpeditionOvernightPrecipitation']), keep_default=False)

        # Adding field 'Expedition.overnight_precipitation_type'
        db.add_column('mammals_expedition', 'overnight_precipitation_type', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='exp_precipitation_type', null=True, to=orm['mammals.ExpeditionOvernightPrecipitationType']), keep_default=False)

        # Deleting field 'TrapLocation.ovenight_precipitation'
        db.delete_column('mammals_traplocation', 'ovenight_precipitation_id')

        # Deleting field 'TrapLocation.ovenight_temperature'
        db.delete_column('mammals_traplocation', 'ovenight_temperature_id')

        # Deleting field 'TrapLocation.ovenight_precipitation_type'
        db.delete_column('mammals_traplocation', 'ovenight_precipitation_type_id')

        # Adding field 'TrapLocation.overnight_temperature'
        db.add_column('mammals_traplocation', 'overnight_temperature', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='trap_temperature', null=True, to=orm['mammals.ExpeditionOvernightTemperature']), keep_default=False)

        # Adding field 'TrapLocation.overnight_precipitation'
        db.add_column('mammals_traplocation', 'overnight_precipitation', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='trap_precipitation', null=True, to=orm['mammals.ExpeditionOvernightPrecipitation']), keep_default=False)

        # Adding field 'TrapLocation.overnight_precipitation_type'
        db.add_column('mammals_traplocation', 'overnight_precipitation_type', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='trap_precipitation_type', null=True, to=orm['mammals.ExpeditionOvernightPrecipitationType']), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Expedition.ovenight_precipitation'
        db.add_column('mammals_expedition', 'ovenight_precipitation', self.gf('django.db.models.fields.related.ForeignKey')(related_name='exp_precipitation', null=True, to=orm['mammals.ExpeditionOvernightPrecipitation'], blank=True), keep_default=False)

        # Adding field 'Expedition.ovenight_temperature'
        db.add_column('mammals_expedition', 'ovenight_temperature', self.gf('django.db.models.fields.related.ForeignKey')(related_name='exp_temperature', null=True, to=orm['mammals.ExpeditionOvernightTemperature'], blank=True), keep_default=False)

        # Adding field 'Expedition.ovenight_precipitation_type'
        db.add_column('mammals_expedition', 'ovenight_precipitation_type', self.gf('django.db.models.fields.related.ForeignKey')(related_name='exp_precipitation_type', null=True, to=orm['mammals.ExpeditionOvernightPrecipitationType'], blank=True), keep_default=False)

        # Deleting field 'Expedition.overnight_temperature'
        db.delete_column('mammals_expedition', 'overnight_temperature_id')

        # Deleting field 'Expedition.overnight_precipitation'
        db.delete_column('mammals_expedition', 'overnight_precipitation_id')

        # Deleting field 'Expedition.overnight_precipitation_type'
        db.delete_column('mammals_expedition', 'overnight_precipitation_type_id')

        # Adding field 'TrapLocation.ovenight_precipitation'
        db.add_column('mammals_traplocation', 'ovenight_precipitation', self.gf('django.db.models.fields.related.ForeignKey')(related_name='trap_precipitation', null=True, to=orm['mammals.ExpeditionOvernightPrecipitation'], blank=True), keep_default=False)

        # Adding field 'TrapLocation.ovenight_temperature'
        db.add_column('mammals_traplocation', 'ovenight_temperature', self.gf('django.db.models.fields.related.ForeignKey')(related_name='trap_temperature', null=True, to=orm['mammals.ExpeditionOvernightTemperature'], blank=True), keep_default=False)

        # Adding field 'TrapLocation.ovenight_precipitation_type'
        db.add_column('mammals_traplocation', 'ovenight_precipitation_type', self.gf('django.db.models.fields.related.ForeignKey')(related_name='trap_precipitation_type', null=True, to=orm['mammals.ExpeditionOvernightPrecipitationType'], blank=True), keep_default=False)

        # Deleting field 'TrapLocation.overnight_temperature'
        db.delete_column('mammals_traplocation', 'overnight_temperature_id')

        # Deleting field 'TrapLocation.overnight_precipitation'
        db.delete_column('mammals_traplocation', 'overnight_precipitation_id')

        # Deleting field 'TrapLocation.overnight_precipitation_type'
        db.delete_column('mammals_traplocation', 'overnight_precipitation_type_id')
