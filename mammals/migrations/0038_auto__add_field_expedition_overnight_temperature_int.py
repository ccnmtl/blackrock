...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Expedition.overnight_temperature_int'
        db.add_column('mammals_expedition', 'overnight_temperature_int', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Expedition.overnight_temperature_int'
        db.delete_column('mammals_expedition', 'overnight_temperature_int')
