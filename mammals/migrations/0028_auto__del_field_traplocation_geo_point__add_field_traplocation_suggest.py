...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'TrapLocation.geo_point'
        db.delete_column('mammals_traplocation', 'geo_point')

        # Adding field 'TrapLocation.suggested_point'
        db.add_column('mammals_traplocation', 'suggested_point', self.gf('django.contrib.gis.db.models.fields.PointField')(null=True, blank=True), keep_default=False)

        # Adding field 'TrapLocation.actual_point'
        db.add_column('mammals_traplocation', 'actual_point', self.gf('django.contrib.gis.db.models.fields.PointField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'TrapLocation.geo_point'
        db.add_column('mammals_traplocation', 'geo_point', self.gf('django.contrib.gis.db.models.fields.PointField')(null=True, blank=True), keep_default=False)

        # Deleting field 'TrapLocation.suggested_point'
        db.delete_column('mammals_traplocation', 'suggested_point')

        # Deleting field 'TrapLocation.actual_point'
        db.delete_column('mammals_traplocation', 'actual_point')
