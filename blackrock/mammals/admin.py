from blackrock.mammals.models import GridPoint, GridSquare, GradeLevel, Bait, \
    School, Species, Animal, Trap, Habitat, ExpeditionMoonPhase, \
    ExpeditionOvernightTemperature, ExpeditionOvernightPrecipitation, \
    ExpeditionOvernightPrecipitationType, ExpeditionCloudCover, Illumination, \
    TrapType, AnimalScaleUsed, AnimalSex, AnimalAge, ObservationType, \
    Expedition, TrapLocation
...
class AnimalAdmin (admin.ModelAdmin):
    ...
    fields = (
        'species', 'description', 'sex', 'age', 'scale_used', 'tag_number',
...
class TrapLocationAdmin (admin.ModelAdmin):
    list_display = ('expedition', 'suggested_point',
                    'actual_point', 'trap_type', 'bait', 'habitat',)
    fields = (
