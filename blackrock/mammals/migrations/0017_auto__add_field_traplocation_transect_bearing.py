...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TrapLocation.transect_bearing'
        db.add_column('mammals_traplocation', 'transect_bearing', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TrapLocation.transect_bearing'
        db.delete_column('mammals_traplocation', 'transect_bearing')
