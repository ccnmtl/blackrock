...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Expedition.school'
        db.alter_column('mammals_expedition', 'school_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mammals.School'], null=True))


    def backwards(self, orm):
        
        # Changing field 'Expedition.school'
        db.alter_column('mammals_expedition', 'school_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))
