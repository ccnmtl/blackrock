...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TrapLocation.team_letter'
        db.add_column('mammals_traplocation', 'team_letter', self.gf('django.db.models.fields.CharField')(default='', max_length=256, blank=True), keep_default=False)

        # Adding field 'TrapLocation.team_number'
        db.add_column('mammals_traplocation', 'team_number', self.gf('django.db.models.fields.IntegerField')(default=1, blank=True), keep_default=False)

        # Adding field 'TrapLocation.order'
        db.add_column('mammals_traplocation', 'order', self.gf('django.db.models.fields.IntegerField')(default=1, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TrapLocation.team_letter'
        db.delete_column('mammals_traplocation', 'team_letter')

        # Deleting field 'TrapLocation.team_number'
        db.delete_column('mammals_traplocation', 'team_number')

        # Deleting field 'TrapLocation.order'
        db.delete_column('mammals_traplocation', 'order')
    ...
    models = {
        ...
        'mammals.traplocation': {
            ...
            'team_letter': ('django.db.models.fields.CharField', [], {'max_length': '256', 'blank': 'True'}),
            'team_number': ('django.db.models.fields.IntegerField', [], {'blank': 'True'}),
