...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('mammals_traplocation', 'understory', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)
    ...
    models = {
        ...
        'mammals.traplocation': {
            ...
            'understory': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
