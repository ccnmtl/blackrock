...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Illumination'
        db.create_table('mammals_illumination', (
        ...
        db.send_create_signal('mammals', ['Illumination'])

        # Adding field 'Expedition.illumination'
        db.add_column('mammals_expedition', 'illumination', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='exp_illumination', null=True, to=orm['mammals.Illumination']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'Illumination'
        db.delete_table('mammals_illumination')

        # Deleting field 'Expedition.illumination'
        db.delete_column('mammals_expedition', 'illumination_id')
