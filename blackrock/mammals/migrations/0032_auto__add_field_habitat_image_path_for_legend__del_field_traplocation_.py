...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Habitat.image_path_for_legend'
        db.add_column('mammals_habitat', 'image_path_for_legend', self.gf('django.db.models.fields.CharField')(default='', max_length=256, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Habitat.image_path_for_legend'
        db.delete_column('mammals_habitat', 'image_path_for_legend')

        # Adding field 'TrapLocation.overnight_precipitation'
        db.add_column('mammals_traplocation', 'overnight_precipitation', self.gf('django.db.models.fields.related.ForeignKey')(related_name='trap_precipitation', null=True, to=orm['mammals.ExpeditionOvernightPrecipitation'], blank=True), keep_default=False)

        # Adding field 'TrapLocation.illumination'
        db.add_column('mammals_traplocation', 'illumination', self.gf('django.db.models.fields.related.ForeignKey')(related_name='trap_illumination', null=True, to=orm['mammals.Illumination'], blank=True), keep_default=False)

        # Adding field 'TrapLocation.cloud_cover'
        db.add_column('mammals_traplocation', 'cloud_cover', self.gf('django.db.models.fields.related.ForeignKey')(related_name='trap_cloudcover', null=True, to=orm['mammals.ExpeditionCloudCover'], blank=True), keep_default=False)

        # Adding field 'TrapLocation.overnight_precipitation_type'
        db.add_column('mammals_traplocation', 'overnight_precipitation_type', self.gf('django.db.models.fields.related.ForeignKey')(related_name='trap_precipitation_type', null=True, to=orm['mammals.ExpeditionOvernightPrecipitationType'], blank=True), keep_default=False)

        # Adding field 'TrapLocation.moon_phase'
        db.add_column('mammals_traplocation', 'moon_phase', self.gf('django.db.models.fields.related.ForeignKey')(related_name='trap_moon_phase', null=True, to=orm['mammals.ExpeditionMoonPhase'], blank=True), keep_default=False)

        # Adding field 'TrapLocation.overnight_temperature'
        db.add_column('mammals_traplocation', 'overnight_temperature', self.gf('django.db.models.fields.related.ForeignKey')(related_name='trap_temperature', null=True, to=orm['mammals.ExpeditionOvernightTemperature'], blank=True), keep_default=False)
