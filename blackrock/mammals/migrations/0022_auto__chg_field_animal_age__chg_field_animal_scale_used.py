...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Animal.age'
        db.alter_column('mammals_animal', 'age_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['mammals.AnimalAge']))

        # Changing field 'Animal.scale_used'
        db.alter_column('mammals_animal', 'scale_used_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['mammals.AnimalScaleUsed']))


    def backwards(self, orm):
        
        # Changing field 'Animal.age'
        db.alter_column('mammals_animal', 'age_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['mammals.AnimalSex']))

        # Changing field 'Animal.scale_used'
        db.alter_column('mammals_animal', 'scale_used_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['mammals.AnimalSex']))
