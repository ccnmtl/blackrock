...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Animal.tag_info'
        db.delete_column('mammals_animal', 'tag_info')


    def backwards(self, orm):
        
        # Adding field 'Animal.tag_info'
        db.add_column('mammals_animal', 'tag_info', self.gf('django.db.models.fields.CharField')(default='', max_length=256, blank=True), keep_default=False)
