            ...
            while (x < tiles):
                ...
                for tree in trees:
                    ...
                    if (adjusted_id not in idmap):
                        ...
                        Contact your developer to fix the id adjustments" \
                        % adjusted_id
                        return
                    ...
                    print '%s,%s,%s,%s,%s' % (adjusted_id, tree[species_idx],
                                              adjusted_x, adjusted_y,
                                              tree[dbh_idx])
                x += 1
                # increment factor tested to ensure that no ids overlap up to a
                # factor of 10. note that making plot odd is pretty key to
                # this.
                plot += 1
            y += 1
