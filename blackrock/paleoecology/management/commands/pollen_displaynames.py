...
from blackrock.paleoecology.models import PollenType
import unicodedata


class Command(BaseCommand):
    def handle(self, *app_labels, **options):
        # 'Usage: python manage.py pollen_displaynames'
        ...
        for obj in objs:
            ...
            obj.name = unicodedata.normalize('NFKD', obj.name).encode(
                'ascii', 'ignore')  # remove any special characters
            obj.save()
