...
jQuery(document).ready(function() {
    jQuery('#scrolling-photo-gallery').jcarousel({
        ...
        itemVisibleInCallback: {
            onBeforeAnimation: detailcarousel_visibleInCallback,
    ...
    if (!document.getElementById('related-items')) {
        ...
        var relatedHeight =
            document.getElementById('related-items').clientHeight;
        var diff = visible - (mapHeight + relatedHeight + 30 /* padding */);
        if (diff > 0) {
