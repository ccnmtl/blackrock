...
/*******************************************************************
* 
*  constructs an array of the blackrock static web cam images that we pull in every x minutes
*
********************************************************************/
...
function get_webcam_image_array(start_date, start_month, start_year, start_hour, start_minute) {
    ...
    /*  count through a 24 hour period, incremending by interval minutes  (19 / hour * 24 = )cal
    ...
    start_minute = Math.round((parseInt(yesterday_date.getMinutes(), 10) / interval)) * interval;
    ...
    for (i = 0; i < image_count; i++) { 
        ...
        current_min_date = new Date(start_min_date.getTime() + (millisecs_per_interval * i));
...
function draw_image_flow(start_date, start_month, start_year, start_hour, start_minute) {
    ...
    imageFlowInstance.init({ ImageFlowID:'webcam-flow',
        ...
        onClick: function(img) {
            ...
            jQuery("#current_image").attr("src", fullUrl.replace("_thumb", ""));
